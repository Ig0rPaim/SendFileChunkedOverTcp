...
SaveInDiskServer servidor = new SaveInDiskServer();
...
//    var total = fileSize / bufferSizeForFileTransfer;
//    long blocksWritted = 0;
...
//        Console.WriteLine($"{blocksWritted} recebidos de {total}");
//        if (bytesRead == 0) break;

//        await fileStream.WriteAsync(buffer, 0, bytesRead);
//        Console.WriteLine($"{blocksWritted} gravados de {total}");
//        blocksWritted++;
